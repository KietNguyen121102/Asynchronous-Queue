...
public class SchedulerSimulation {
    public static ArrayList<Double> schedulerSimulation(int onlineBaristas, int physicalBaristas, double processingTime, int ArrivalRate, double alpha, int[] decisions) {
