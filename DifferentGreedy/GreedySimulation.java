...
public class GreedySimulation {
    ...
    public static double pessGreedyCustomerInHybrid(int onlineBaristas, int physicalBaristas, double processingTime, int ArrivalRate, double alpha, int totalCustomers) {
        // every minute in an 8-hour working day
        ArrayList<Integer> greedyStrategy = new ArrayList<Integer>();
        double[] costOfGreedy = new double[totalCustomers];
        int numCustomer = 0;
